...
public final class ItemApplicationBinding implements ViewBinding {
  ...
  private ItemApplicationBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView tvAppliedDate, @NonNull TextView tvCourseName, @NonNull TextView tvStatus) {
  ...
  public static ItemApplicationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemApplicationBinding((MaterialCardView) rootView, tvAppliedDate, tvCourseName,
          tvStatus);
    }
