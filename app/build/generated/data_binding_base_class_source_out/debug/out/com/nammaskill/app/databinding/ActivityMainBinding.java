...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView networkBanner;

  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomNavigationView bottomNavigationView,
      @NonNull FragmentContainerView navHostFragment, @NonNull TextView networkBanner) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.networkBanner;
      TextView networkBanner = ViewBindings.findChildViewById(rootView, id);
      if (networkBanner == null) {
        break missingId;
      }

      return new ActivityMainBinding((CoordinatorLayout) rootView, bottomNavigationView,
          navHostFragment, networkBanner);
    }
